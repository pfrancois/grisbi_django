...
class Test_models(TestCase):
    ...
    def test_moyen_fusionne(self):
        ...
        self.assertQuerysetEqual(Moyen.objects.order_by('id'), [1, 2, 4, 5, 6], attrgetter("id"))
    ...
    def test_pre_delete_ope_titre_rapp(self):
        ...
        o.rapp = Rapp.objects.get(id=1)
        o.save()
        self.assertRaises(IntegrityError, Ope_titre.objects.get(id=o.ope_titre_ost.id).delete)
