...
from mysite.gsb.models import Compte_titre, Virement, Ope_titre, Ib, Exercice, Cours, Rapp, Echeance, Gsb_exc
import datetime
import decimal
...
class test_models(TestCase):
    ...
    def test_investietnb(self):
        ...
        self.assertEqual(Titre.objects.get(id=2).investi(rapp=True), 0)#todo ajouter des operation afin que l'on trouv un chiffre
        ...
        self.assertEqual(Titre.objects.get(id=2).nb(rapp=True), 0)#todo ajouter des operation afin que l'on trouv un chiffre
