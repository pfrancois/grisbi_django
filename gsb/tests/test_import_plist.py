...
class Test_import_money_journal_element(Test_import_abstract):
    def test_money_journal_element_ope(self):
        ...
        self.compare(el.is_compte, False)
        self.compare(el.is_budget, False)
        self.compare(el.lastup,  pytz.timezone(settings.TIME_ZONE).localize(datetime.datetime(2014, 6,  17, 22, 17, 47, 95470)))
        self.compare(el.id, 66)
        self.compare(el.cat, 1)
        self.compare(el.automatique, False)
        self.compare(el.date,  datetime.date(2014, 6, 16))
...
class Test_import_money_journal_export(Test_import_abstract):
    ...
    def test_global(self):
        with Replacer() as r:
            ...
            models.Db_log.objects.create(datamodel="cat",id_model=1,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07901", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="cat",id_model=2,type_action="I", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07902", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="cat",id_model=72,type_action="I", uuid="51a0004d-7f28-427b-8cf7-44ad2ac07972", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            #du fait du auto_add dans le model besoin de deux etapes
            models.Db_log.objects.create(datamodel="cat",id_model=35,type_action="I", uuid="51a0004d-7f28-427b-8cf7-44ad2ac07972", date_time_action=self.strptime("2012-06-23 18:51:40.571000+00:00"))
            ...
            models.Db_log.objects.create(datamodel="cat",id_model=4,type_action="D", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a01", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Compte.objects.filter(id=1).update(nom="compte_modifie")
            cpt_temp=models.Compte.objects.create(nom="Compte nouveau")
            models.Db_log.objects.create(datamodel="compte",id_model=1,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a01", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="compte",id_model=3,type_action="I", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a01", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            #on mock les opes
            models.Db_log.objects.create(datamodel="ope",id_model=1,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a01", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=2,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a02", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=3,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a03", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=8,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a08", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=9,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a09", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=11,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a10", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=12,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a11", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=13,type_action="U", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a12", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=14,type_action="I", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a13", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=15,type_action="I", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a14", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=16,type_action="I", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a15", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=17,type_action="I", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a16", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=18,type_action="I", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a17", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
            models.Db_log.objects.create(datamodel="ope",id_model=19,type_action="D", uuid="51a6674d-7f28-427b-8cf7-25ad2ac07a18", date_time_action=self.strptime("2014-06-23 18:51:40.571000+00:00"))
