...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Tiers', fields ['sort_nom']
        db.delete_unique(u'gsb_tiers', ['sort_nom'])


    def backwards(self, orm):
        # Adding unique constraint on 'Tiers', fields ['sort_nom']
        db.create_unique(u'gsb_tiers', ['sort_nom'])
