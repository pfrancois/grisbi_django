    ...
    def forwards(self, orm):
        ...
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('ope',datetime('NOW'),old.id, 'U',old.uuid);
        end;""")
        db.execute("""create trigger insert_ope after insert on gsb_ope
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('ope',datetime('NOW'),new.id, 'I',new.uuid);
        end;""")
        db.execute("""create trigger delete_ope delete on gsb_ope
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('ope',datetime('NOW'),old.id, 'D',old.uuid);
        end;
        """)
        #cat
        ...
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('cat',datetime('NOW'),old.id, 'U',old.uuid);
        end;""")
        db.execute("""create trigger insert_cat after insert on gsb_cat
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('cat',datetime('NOW'),new.id, 'I',new.uuid);
        end;""")
        db.execute("""create trigger delete_cat delete on gsb_cat
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('cat',datetime('NOW'),old.id, 'D',old.uuid);
        end;
        """)
        #compte
        ...
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('compte',datetime('NOW'),old.id, 'U',old.uuid);
        end;""")
        db.execute("""create trigger insert_compte after insert on gsb_cat
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('compte',datetime('NOW'),new.id, 'I',new.uuid);
        end;""")
        db.execute("""create trigger delete_compte delete on gsb_cat
        begin
            insert into gsb_db_log (datamodel,date_time_created,id_model,memo,uuid)
                values ('compte',datetime('NOW'),old.id, 'D',old.uuid);
        end;
        """)
