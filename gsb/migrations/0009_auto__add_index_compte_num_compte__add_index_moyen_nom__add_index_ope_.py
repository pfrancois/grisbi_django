...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Compte', fields ['num_compte']
        db.create_index('gsb_compte', ['num_compte'])

        # Adding index on 'Moyen', fields ['nom']
        db.create_index('gsb_moyen', ['nom'])

        # Adding index on 'Ope_titre', fields ['date']
        db.create_index('gsb_ope_titre', ['date'])

        # Adding index on 'Ope', fields ['date']
        db.create_index('gsb_ope', ['date'])

        # Adding index on 'Cours', fields ['date']
        db.create_index('gsb_cours', ['date'])

        # Adding index on 'Banque', fields ['cib']
        db.create_index('gsb_banque', ['cib'])

        # Adding index on 'Echeance', fields ['date_limite']
        db.create_index('gsb_echeance', ['date_limite'])

        # Adding index on 'Echeance', fields ['date']
        db.create_index('gsb_echeance', ['date'])


    def backwards(self, orm):
        # Removing index on 'Echeance', fields ['date']
        db.delete_index('gsb_echeance', ['date'])

        # Removing index on 'Echeance', fields ['date_limite']
        db.delete_index('gsb_echeance', ['date_limite'])

        # Removing index on 'Banque', fields ['cib']
        db.delete_index('gsb_banque', ['cib'])

        # Removing index on 'Cours', fields ['date']
        db.delete_index('gsb_cours', ['date'])

        # Removing index on 'Ope', fields ['date']
        db.delete_index('gsb_ope', ['date'])

        # Removing index on 'Ope_titre', fields ['date']
        db.delete_index('gsb_ope_titre', ['date'])

        # Removing index on 'Moyen', fields ['nom']
        db.delete_index('gsb_moyen', ['nom'])

        # Removing index on 'Compte', fields ['num_compte']
        db.delete_index('gsb_compte', ['num_compte'])
    ...
    models = {
        ...
        u'gsb.cours': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 16, 0, 0)', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'gsb.exercice': {
            ...
            'date_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 16, 0, 0)'}),
        ...
        u'gsb.rapp': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
