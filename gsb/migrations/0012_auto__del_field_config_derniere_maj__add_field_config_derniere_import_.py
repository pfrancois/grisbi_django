...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'config.derniere_maj'
        db.delete_column(u'gsb_config', 'derniere_maj')

        # Adding field 'config.derniere_import_money_journal'
        db.add_column('gsb_config', 'derniere_import_money_journal',
        ...
        db.add_column('gsb_config', 'derniere_export_money_journal',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'config.derniere_maj'
        db.add_column(u'gsb_config', 'derniere_maj',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)

        # Deleting field 'config.derniere_import_money_journal'
        db.delete_column('gsb_config', 'derniere_import_money_journal')

        # Deleting field 'config.derniere_export_money_journal'
        db.delete_column('gsb_config', 'derniere_export_money_journal')
    ...
    models = {
        ...
        u'gsb.cours': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 0, 0)', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'gsb.exercice': {
            ...
            'date_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 0, 0)'}),
        ...
        u'gsb.rapp': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
