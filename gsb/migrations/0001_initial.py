...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gsb_tiers', (
            ...
            ('sort_nom', self.gf('django.db.models.fields.CharField')(max_length=40, db_index=True)),
        ))
        ...
        db.create_table('gsb_cours', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 9, 20, 0, 0), db_index=True)),
        ...
        db.create_table('gsb_exercice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_debut', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 9, 20, 0, 0))),
        ...
        db.create_table('gsb_rapp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, db_index=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 9, 20, 0, 0), null=True, blank=True)),
            ('lastupdate', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
        ))
        ...
        db.create_table(u'gsb_db_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_time_action', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ...
            ('type_action', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('memo', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('date_ref', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
        ))
    ...
    models = {
        ...
        u'gsb.cours': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 20, 0, 0)', 'db_index': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'gsb.db_log': {
            ...
            'date_ref': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
        ...
        u'gsb.exercice': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'date_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 20, 0, 0)'}),
        ...
        u'gsb.rapp': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
