...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gsb_titre', (
            ...
            ('tiers', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gsb.Tiers'], unique=True, null=True, blank=True)),
        ...
        db.create_table('gsb_cours', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 1, 0, 0))),
        ...
        db.create_table('gsb_banque', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cib', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, db_index=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('lastupdate', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
        ...
        db.create_table('gsb_exercice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_debut', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 1, 0, 0))),
        ...
        db.create_table('gsb_compte', (
            ...
            ('num_compte', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True)),
        ...
        db.create_table('gsb_ope_titre', (
            ...
            ('nombre', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=5)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('cours', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=15, decimal_places=5)),
            ('invest', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2)),
            ('ope', self.gf('django.db.models.fields.related.OneToOneField')(related_name='ope', unique=True, null=True, to=orm['gsb.Ope'])),
            ('ope_pmv', self.gf('django.db.models.fields.related.OneToOneField')(related_name='ope_pmv', unique=True, null=True, to=orm['gsb.Ope'])),
            ('lastupdate', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
        ))
        ...
        db.create_table('gsb_moyen', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('type', self.gf('django.db.models.fields.CharField')(default='d', max_length=1)),
            ('lastupdate', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
        ))
        ...
        db.create_table('gsb_rapp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, db_index=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 1, 0, 0), null=True, blank=True)),
            ('lastupdate', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
        ))
        ...
        db.create_table('gsb_echeance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 1, 0, 0))),
            ('date_limite', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
        ...
        db.create_table('gsb_ope', (
            ...
            ('montant', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=15, decimal_places=2)),
            ('tiers', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['gsb.Tiers'], null=True, on_delete=models.PROTECT, blank=True)),
            ...
            ('mere', self.gf('django.db.models.fields.related.ForeignKey')(related_name='filles_set', on_delete=models.PROTECT, default=None, to=orm['gsb.Ope'], blank=True, null=True)),
    ...
    models = {
        ...
        u'gsb.cours': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 1, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'gsb.exercice': {
            ...
            'date_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 1, 0, 0)'}),
        ...
        u'gsb.ope': {
            ...
            'tiers': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['gsb.Tiers']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
        u'gsb.ope_titre': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invest': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '15', 'decimal_places': '2'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nombre': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '15', 'decimal_places': '5'}),
            'ope': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'ope'", 'unique': 'True', 'null': 'True', 'to': u"orm['gsb.Ope']"}),
            'ope_pmv': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'ope_pmv'", 'unique': 'True', 'null': 'True', 'to': u"orm['gsb.Ope']"}),
            'titre': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gsb.Titre']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
        u'gsb.rapp': {
            'Meta': {'ordering': "['-date']", 'object_name': 'Rapp'},
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        ...
        u'gsb.titre': {
            ...
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'tiers': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['gsb.Tiers']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
