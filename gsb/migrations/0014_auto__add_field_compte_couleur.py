...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compte.couleur'
        db.add_column('gsb_compte', 'couleur',
                      self.gf('colorful.fields.RGBColorField')(default='#FFFFFF', max_length=7),
                      keep_default=False)

        # Adding field 'Cat.couleur'
        db.add_column('gsb_cat', 'couleur',
                      self.gf('colorful.fields.RGBColorField')(default='#FFFFFF', max_length=7),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Compte.couleur'
        db.delete_column('gsb_compte', 'couleur')

        # Deleting field 'Cat.couleur'
        db.delete_column('gsb_cat', 'couleur')
    ...
    models = {
        ...
        u'gsb.cours': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)', 'db_index': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'gsb.exercice': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'date_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)'}),
        ...
        u'gsb.rapp': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
