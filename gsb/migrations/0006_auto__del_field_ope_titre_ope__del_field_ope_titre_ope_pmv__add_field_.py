...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ope_titre.ope'
        db.delete_column(u'gsb_ope_titre', 'ope_id')

        # Deleting field 'Ope_titre.ope_pmv'
        db.delete_column(u'gsb_ope_titre', 'ope_pmv_id')

        # Adding field 'Ope.ope_titre_ost'
        db.add_column('gsb_ope', 'ope_titre_ost',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='ope_ost', unique=True, null=True, to=orm['gsb.Ope_titre']),
                      keep_default=False)

        # Adding field 'Ope.ope_titre_pmv'
        db.add_column('gsb_ope', 'ope_titre_pmv',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'gsb_ope_titre', 'ope',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='ope', unique=True, null=True, to=orm['gsb.Ope']),
                      keep_default=False)

        # Adding field 'Ope_titre.ope_pmv'
        db.add_column(u'gsb_ope_titre', 'ope_pmv',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='ope_pmv', unique=True, null=True, to=orm['gsb.Ope']),
                      keep_default=False)

        # Deleting field 'Ope.ope_titre_ost'
        db.delete_column('gsb_ope', 'ope_titre_ost_id')
    ...
    models = {
        ...
        u'gsb.cours': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'gsb.exercice': {
            ...
            'date_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 2, 0, 0)'}),
        ...
        u'gsb.ope': {
            ...
            'ope_titre_pmv': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'ope_pmv'", 'unique': 'True', 'null': 'True', 'to': u"orm['gsb.Ope']"}),
        ...
        u'gsb.rapp': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 2, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
