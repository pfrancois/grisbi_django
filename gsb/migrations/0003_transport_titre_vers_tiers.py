...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for tiers in orm.Tiers.objects.all():
            try:
                tiers.titre = tiers.titre_temp
                tiers.save()
            except orm.Titre.DoesNotExist:
                pass

    def backwards(self, orm):
        for titre in orm.Titre.objects.all():
            try:
                titre.ters = titre.tiers_temp
                titre.save()
            except orm.Tiers.DoesNotExist:
                pass
