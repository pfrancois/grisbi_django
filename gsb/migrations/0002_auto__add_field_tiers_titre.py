...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tiers.titre'
        db.add_column('gsb_tiers', 'titre',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='tiers_temp', unique=True, null=True, to=orm['gsb.Titre']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Tiers.titre'
        db.delete_column('gsb_tiers', 'titre_id')
    ...
    models = {
        ...
        u'gsb.tiers': {
            ...
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'titre': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'tiers_temp'", 'unique': 'True', 'null': 'True', 'to': u"orm['gsb.Titre']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
        u'gsb.titre': {
            ...
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'tiers': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'titre_temp'", 'unique': 'True', 'null': 'True', 'to': u"orm['gsb.Tiers']"}),
