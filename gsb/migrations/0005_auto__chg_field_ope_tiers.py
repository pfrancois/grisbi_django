...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ope.tiers'
        db.alter_column('gsb_ope', 'tiers_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gsb.Tiers'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Ope.tiers'
        db.alter_column('gsb_ope', 'tiers_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gsb.Tiers'], null=True, on_delete=models.PROTECT))
