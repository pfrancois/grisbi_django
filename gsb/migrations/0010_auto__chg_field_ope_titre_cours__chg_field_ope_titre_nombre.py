...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ope_titre.cours'
        db.alter_column('gsb_ope_titre', 'cours', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=6))

        # Changing field 'Ope_titre.nombre'
        db.alter_column('gsb_ope_titre', 'nombre', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Ope_titre.cours'
        db.alter_column('gsb_ope_titre', 'cours', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=5))

        # Changing field 'Ope_titre.nombre'
        db.alter_column('gsb_ope_titre', 'nombre', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=5))
    ...
    models = {
        ...
        u'gsb.cours': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 20, 0, 0)', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'gsb.exercice': {
            ...
            'date_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 20, 0, 0)'}),
        ...
        u'gsb.rapp': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
