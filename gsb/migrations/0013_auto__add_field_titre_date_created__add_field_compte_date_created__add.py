...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Titre.date_created'
        db.add_column(u'gsb_titre', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Compte.date_created'
        db.add_column('gsb_compte', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exercice.date_created'
        db.add_column('gsb_exercice', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Moyen.date_created'
        db.add_column('gsb_moyen', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ope_titre.date_created'
        db.add_column('gsb_ope_titre', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cat.date_created'
        db.add_column('gsb_cat', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ope.date_created'
        db.add_column('gsb_ope', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Changing field 'Ope.mere'
        db.alter_column('gsb_ope', 'mere_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gsb.Ope']))
        # Adding field 'Cours.date_created'
        db.add_column('gsb_cours', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Rapp.date_created'
        db.add_column('gsb_rapp', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tiers.date_created'
        db.add_column('gsb_tiers', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Echeance.date_created'
        db.add_column('gsb_echeance', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ib.date_created'
        db.add_column('gsb_ib', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Titre.date_created'
        db.delete_column(u'gsb_titre', 'date_created')

        # Deleting field 'Compte.date_created'
        db.delete_column('gsb_compte', 'date_created')

        # Deleting field 'Exercice.date_created'
        db.delete_column('gsb_exercice', 'date_created')

        # Deleting field 'Moyen.date_created'
        db.delete_column('gsb_moyen', 'date_created')

        # Deleting field 'Ope_titre.date_created'
        db.delete_column('gsb_ope_titre', 'date_created')

        # Deleting field 'Cat.date_created'
        db.delete_column('gsb_cat', 'date_created')

        # Deleting field 'Ope.date_created'
        db.delete_column('gsb_ope', 'date_created')

        # Changing field 'Ope.mere'
        db.alter_column('gsb_ope', 'mere_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['gsb.Ope'], null=True))
        # Deleting field 'Cours.date_created'
        db.delete_column('gsb_cours', 'date_created')

        # Deleting field 'Rapp.date_created'
        db.delete_column('gsb_rapp', 'date_created')

        # Deleting field 'Tiers.date_created'
        db.delete_column('gsb_tiers', 'date_created')

        # Deleting field 'Echeance.date_created'
        db.delete_column('gsb_echeance', 'date_created')

        # Deleting field 'Ib.date_created'
        db.delete_column('gsb_ib', 'date_created')
    ...
    models = {
        ...
        u'gsb.cours': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)', 'db_index': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'gsb.exercice': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'date_debut': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
        ...
        u'gsb.rapp': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdate': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
