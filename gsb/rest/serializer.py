...
class CompteSerializer(serializers.ModelSerializer):
    class Meta(object):
        model =  models.Compte
        fields = ('nom','type', 'titulaire', 'banque','ouvert','notes','moyen_credit_defaut',
                  'moyen_debit_defaut','couleur', 'uuid', 'lastupdate', 'date_created')
...
class EcheanceSerializer(serializers.ModelSerializer):
    class Meta(object):
        ...
        fields = ('date','date_limite', 'intervalle', 'periodicite', 'valide',
                  'compte', 'montant', 'tiers', 'cat', 'moyen', 'ib', 'compte_virement', 'moyen_virement',
                  'exercice', 'notes', 'inscription_automatique', 'uuid', 'lastupdate', 'date_created')

class OpeSerializer(serializers.ModelSerializer):
    class Meta(object):
        model =  models.Ope
        fields = ('compte','date','date_val','montant','tiers','cat','moyen','ib',
                  'num_cheque', 'pointe', 'exercice', 'notes',
                  'uuid', 'lastupdate', 'date_created')