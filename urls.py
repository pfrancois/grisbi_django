...
from gsb import views, outils
from gsb.io import import_csv, export_csv, lecture_plist
from gsb.io import import_titre_csv as import_titres
...
admin.autodiscover()
urlpatterns = [
    url(r'^gestion_bdd/', admin.site.urls),
]
...
urlpatterns += [url(r'^$', views.Index_view.as_view(), name='index'),
                url(r'^rest/', include(gsb.rest.url), name="rest"),
